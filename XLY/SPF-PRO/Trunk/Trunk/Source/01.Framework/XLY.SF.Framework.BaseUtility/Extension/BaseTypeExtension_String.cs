...
namespace XLY.SF.Framework.BaseUtility
{
    public static partial class BaseTypeExtension
    {
        ...
        #region 将一个Base64编码的字符串解码为ASCII编码的字符串

        /// <summary>
        /// 将一个Base64编码的字符串解码为ASCII编码的字符串
        /// </summary>
        ...
        #region 截取固定长度的字符串，如果长度小于目标值则补齐
        /// <summary>
        /// 截取固定长度的字符串，如果长度小于目标值则补齐，超出则截断
        /// </summary>
        /// <param name="str"></param>
        /// <param name="maxlength"></param>
        /// <param name="fillChar"></param>
        /// <returns></returns>
        public static string GetStrictLength(this string str, int maxlength, char? fillChar = null)
        {
            if (str == null)
                return str;
            ...
            else if (str.Length < maxlength && fillChar.HasValue)
            {
                return str.PadRight(maxlength, (char)fillChar);
            }
            return str;
        }
        #endregion
