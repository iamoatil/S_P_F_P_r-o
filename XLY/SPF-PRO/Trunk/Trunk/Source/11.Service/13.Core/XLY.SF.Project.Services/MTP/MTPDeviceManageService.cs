// ***********************************************************************
// Assembly:XLY.SF.Project.Services
// Author:Songbing
// Created:2017-05-25 14:33:32
// Description:
// ***********************************************************************
// Last Modified By:
// Last Modified On:
...
namespace XLY.SF.Project.Services
{
    ...
    /// MTP设备管理服务
    /// </summary>
    public class MTPDeviceManageService
    {
        /// <summary>
        /// 唯一实例
        /// </summary>
        public static MTPDeviceManageService Instance
        {
            get { return SingleWrapperHelper<MTPDeviceManageService>.Instance; }
        }
        ...
        public MTPDevice GetMTPDevice(Device device)
        {
            ...
            {
                //优先使用序列号匹配
                var dd = devices.FirstOrDefault((d) => d.SerialNumber == device.ID);
