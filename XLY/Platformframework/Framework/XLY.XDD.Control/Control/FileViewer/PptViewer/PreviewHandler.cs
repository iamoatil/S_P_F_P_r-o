...
{
    public class PreviewHandlerHost : System.Windows.Forms.Control
    {
        ...
        public void Close()
        {
            if (this.mCurrentPreviewHandlerStream != null)
            {
                this.mCurrentPreviewHandlerStream.Close();
                this.mCurrentPreviewHandlerStream.Dispose();
            }
        }
