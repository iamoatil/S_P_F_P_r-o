...
namespace XLY.XDD.Control
{
    public class EditableBitmap : IDisposable
    {
        ...
        public EditableBitmap(Bitmap source, System.Drawing.Imaging.PixelFormat format)
        ...
        public EditableBitmap(Bitmap source, System.Drawing.Imaging.PixelFormat format, int newWidth, int newHeight)
        ...
        /// <param name="format"></param>
        public EditableBitmap(int width, int height,System.Drawing.Imaging.PixelFormat format)
        {
    ...
    internal class SharedPinnedByteArray
    {
        ...
        private void Destroy()
        {
            if(!destroyed)
            {
                ...
                {
                   //LogHelper.Error("Í¼Æ¬ÊÓÍ¼Òì³££º"+ ex.AllMessage(),ex);
                }
