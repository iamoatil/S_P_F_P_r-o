...
namespace System
{
    ...
    public static partial class TypeExtension
    {
        ...
        private readonly static DateTime _startDt = new DateTime(1970, 1, 1, 0, 0, 0);
        public static DateTime? ToSafeDateTime(this Int64 dateTime)
        {
            if(dateTime.ToSafeString().Length <= 10)
            {
                return _startDt.AddSeconds(dateTime);
            }
            else
            {
                return _startDt.AddMilliseconds(dateTime);
            }
        }
